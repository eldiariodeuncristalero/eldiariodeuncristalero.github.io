    ...
    e.Agegate = function(e) { var t = { cookie: "popup_agreed", body: "Este canal está dirigido a público adulto", cancelUrl: "/", expires: 7, success: function() {}, fail: function() {} }; if (e = void 0 !== e ? e : {}, this.setOptions(e, t), !this.checkCookie(this.options.cookie)) return this.createPopup(), this.setEventHandlers(), this.freezeScrolling(), this }, Agegate.prototype = { createPopup: function() { this.container = document.createElement("div"), this.container.innerHTML = ['<div class="popup-backdrop" style="z-index: 1000; position: fixed; top: 0; right: 0; left: 0; bottom: 0; background-color: #242629; opacity: 0.78; overflow-x: hidden; overflow-y: auto;"></div>', '<div class="popup-modal" style="z-index: 1001; position: fixed; top: 0; right: 0; left: 0; bottom: 0; padding: 10px;">', '<div class="popup-container">', '<div class="popup-body">', this.options.body, "</div>", '<div class="popup-actions">', '<button class="popup-btn popup-agree">Continuar</button>', '<button class="popup-btn popup-cancel">Salir</button>', "</div>", "</div>", "</div>"].join(""), document.body.insertBefore(this.container, document.body.firstChild), this.agreeBtn = this.container.querySelector(".popup-agree"), this.cancelBtn = this.container.querySelector(".popup-cancel") }, destroyPopup: function() { this.container.parentNode.removeChild(this.container), this.allowScrolling() }, successHandler: function() { this.setCookie(), this.destroyPopup(), this.options.success() }, failHandler: function() { this.options.fail(), e.location.href = this.options.cancelUrl }, setOptions: function(e, t) { this.options = Object.assign(t, e, { defaults: t }) }, checkCookie: function(e) { return Cookies.get(e) }, setCookie: function() { Cookies.set(this.options.cookie, !0, { expires: this.options.expires }) }, setEventHandlers: function() { this.agreeBtn.addEventListener("click", this.successHandler.bind(this), !1), this.cancelBtn.addEventListener("click", this.failHandler.bind(this), !1) }, freezeScrolling: function() { document.body.style.overflowY = "hidden" }, allowScrolling: function() { document.body.style.overflowY = "auto" } }, "function" != typeof Object.assign && Object.defineProperty(Object, "assign", {
        ...
        function(t) {
            ...
            if ("function" == typeof define && define.amd && (define(t), o = !0), "object" == typeof exports && (module.exports = t(), o = !0), !o) {
                var n = e.Cookies,
                    i = e.Cookies = t();
                i.noConflict = function() { return e.Cookies = n, i }
            }
        }(function() {
            function e() { for (var e = 0, t = {}; e < arguments.length; e++) { var o = arguments[e]; for (var n in o) t[n] = o[n] } return t }
            ...
            function t(o) {
                function n(t, i, r) {
                    ...
                    if ("undefined" != typeof document) {
                        if (arguments.length > 1) {
                            if ("number" == typeof(r = e({ path: "/" }, n.defaults, r)).expires) {
                                var s = new Date;
                        ...
                        for (var l = document.cookie ? document.cookie.split("; ") : [], u = /(%[0-9A-Z]{2})+/g, d = 0; d < l.length; d++) {
                            ...
                            try {
                                ...
                                if (h = o.read ? o.read(h, v) : o(h, v) || h.replace(u, decodeURIComponent), this.json) try { h = JSON.parse(h) } catch (e) {}
                                if (t === v) { c = h; break }
                                t || (c[v] = h)
                            } catch (e) {}
                        }
                ...
                return n.set = n, n.get = function(e) { return n.call(n, e) }, n.getJSON = function() { return n.apply({ json: !0 }, [].slice.call(arguments)) }, n.defaults = {}, n.remove = function(t, o) { n(t, "", e(o, { expires: -1 })) }, n.withConverter = t, n
            }
            return t(function() {})
        })
}(window);